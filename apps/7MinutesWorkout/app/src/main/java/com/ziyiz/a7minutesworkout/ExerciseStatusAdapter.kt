...
import com.ziyiz.a7minutesworkout.databinding.ItemExerciseStatusBinding
...
class ExerciseStatusAdapter(val items: ArrayList<ExerciseModel>):
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when {
            model.getIsSelected() -> {
                holder.tvItem.background = ContextCompat.getDrawable(holder.itemView.context, R.drawable.item_circular_thin_color_accent_board)
